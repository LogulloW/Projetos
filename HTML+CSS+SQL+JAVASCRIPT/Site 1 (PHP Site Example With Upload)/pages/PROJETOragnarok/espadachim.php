...
<div  class="centersite">
  <h2 class="glow">ESPADACHINS</h2><br>
  <h1>Este site foi feito com o propósito de proporcionar para os jogadores, builds e outras informações do jogo, as páginas de builds possuirão os Atributos, as Habilidades e os Items, além de informações do por que de cada escolha e algumas mecânicas das classes.<br><br> Então, Divirtam-se!<br><br></h1><img class="centersite" src="../../jpg/Wallnarok.jpg">
</div>
  </body>
</html> 